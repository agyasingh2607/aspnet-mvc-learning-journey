...
namespace Bloggie.Web.Repositories
{
    public class TagRepository : ITagRepository
    {
        ...
        {
            await _bloggieDbContext.Tags.AddAsync(tag); //in these two lines we are doing database call to add the tag to the database, so we need to make this method asynchronous and use await keyword
